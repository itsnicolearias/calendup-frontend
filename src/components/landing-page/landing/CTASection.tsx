...
function CTASection() {
  ...
  return (
    <div>
       {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-[#ac043f] to-[#0388bd]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-[#0388bd] px-8 py-4 text-lg font-semibold rounded-xl transition-all duration-200 bg-transparent"
            >
              Contactar ventas
            </Button>
          </div>
